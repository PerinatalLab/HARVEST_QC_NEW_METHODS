...
cmnd01d = paste(plink," --bfile ",temp_genet,"_0dup --update-sex ",famids," --make-bed --out ",temp_genet,"_1dup",sep="")
cmnd01o = paste(plink," --bfile ",temp_genet,"_0oth --update-sex ",famids," --make-bed --out ",temp_genet,"_1oth",sep="")
cmnd02d = paste(plink," --bfile ",temp_genet,"_1dup --update-ids ",gender," --make-bed --out ",temp_genet,"_2dup",sep="")
cmnd02o = paste(plink," --bfile ",temp_genet,"_1oth --update-ids ",gender," --make-bed --out ",temp_genet,"_2oth",sep="")
